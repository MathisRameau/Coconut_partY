...
void play_area(Case** game_board, Case** chemin, int* taille_chemin, int height, int width, int* start_x, int* start_y, int* zone_top){

      if(!game_board || !chemin || !taille_chemin || !start_x || !start_y) exit(27);
