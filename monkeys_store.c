...
void monkeys_store(Monkey* tab_monkey, int* nb_monkeys, int* nb_ndc) {
      ...
      if (choix == ACHETER) {
            ...
            } while (amelioration < 1 || amelioration > *nb_monkeys);
            ...
            if (tab_monkey[amelioration].level == 3) {
                  ...
                  *nb_ndc -= prix_amelioration[tab_monkey[amelioration].level - 1];

                  printf("Félicitations! Vous avez amélioré le singe %d : niveau %d --> niveau %d\n",
                        amelioration + 1,
                        tab_monkey[amelioration].level - 1,
                        tab_monkey[amelioration].level);
